...
export default function HUD() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[100] p-6 md:p-12 mix-blend-difference opacity-40">
      {/* Top Right: Time & Location — Hidden on mobile */}
      <div className="hidden md:flex absolute top-12 right-12 flex flex-col items-end gap-1">
      ...
      {/* Top Center: Navigation Matrix — Hidden on mobile */}
      <div className="hidden md:flex absolute top-24 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
      ...
      <div className="hidden md:block absolute left-6 top-1/4 bottom-1/4 w-[1px] bg-gradient-to-b from-transparent via-[var(--border)] to-transparent" />
      <div className="hidden md:block absolute right-6 top-1/4 bottom-1/4 w-[1px] bg-gradient-to-b from-transparent via-[var(--border)] to-transparent" />
